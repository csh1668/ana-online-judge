...
function GroupProblemMembersNotice({
	...
	return (
		<div className="rounded-[2px] border border-border bg-muted/40 p-4 text-sm space-y-2">
			...
			<Link
				...
				className="text-accent underline-offset-4 hover:underline inline-block"
			>
				그룹 멤버 탭으로 이동 →
			</Link>
