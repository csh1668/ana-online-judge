...
export function AddParticipantDialog({ contestId }: AddParticipantDialogProps) {
    ...
    const [searchResults, setSearchResults] = useState<Array<{ id: number; username: string; name: string }>>([]);
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogDescription>사용자 아이디나 이름을 검색하여 참가자를 추가하세요.</DialogDescription>
                </DialogHeader>
                <div className="space-y-4 py-4">
                    ...
                    {!isSearching && searchQuery.trim().length >= 2 && searchResults.length === 0 && !error && (
