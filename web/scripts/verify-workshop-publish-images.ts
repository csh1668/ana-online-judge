/**
 * Run with: `cd web && pnpm tsx scripts/verify-workshop-publish-images.ts`
 *
 * Exit 0 on success, 1 on any assertion failure. Prints each case.
 */

import { rewriteWorkshopImageUrls } from "@/lib/services/workshop-publish-images";
...
const cases: Case[] = [
	...
	},
	{
		...
		input: "![a](images/workshopProblems/5/x.png) ![b](images/workshopProblems/5/x.png)",
		workshopId: 5,
		publishedId: 12,
